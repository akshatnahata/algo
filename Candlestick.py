...
url = "https://priceapi.moneycontrol.com/techCharts/techChartController/history?symbol=23&resolution=1D&from="+str(start)+"&to="+str(end)
# print(url)
...
intraday_data.to_csv('Reliance.csv')